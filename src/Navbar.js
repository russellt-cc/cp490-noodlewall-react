    ...
    return (
      <nav>
        ...
        <div id="nav_left" class="nav_column">
          <a href="index.html">
            <img id="nav_logo" src={logo} height="50px"/>
          </a>
        ...
        <div id="nav_right" class="nav_column">
          <ul>
            ...
            <li id="user_button" class="drop_button">
              <a href="#"><img id="nav_user_image" src={user_icon} height="50px"/></a>

  ...
  render() {
    ...
    if (this.state && this.state.userIsLoaded) {
      ...
      if (!this.state.error) {
            ...
            >
              {this.state.isOwnProfile ? (
                <div id="profile_own_profile_status_bar">
                  <p>
                    Hi {thisUser.userFirstName}! You can edit your profile,
                    manage events, and view your dashboard from this page.
                  </p>
                </div>
              ) : (
                <></>
        ...
        return (
          <main>
            <p>User failed to load! Error: {this.state.error.message}</p>
          </main>
        );
      }
    } else {

      ...
      <main id="landing">
        ...
        <section id="intro">
          ...
          <div id="intro_left" className="intro_column">
            <h1>
              Take a <span className="dreams_color_text">dream</span> and{" "}
              <span className="events_color_text">make it happen!</span>
            </h1>
            <p>
              Have a dream worth sharing? Make it reality with{" "}
              <span className="dreams_color_text">Noodlewall</span>.
            </p>
            <p>
              <span className="events_color_text">You're an influencer</span>, a
              person who makes events happen.{" "}
              <span className="dreams_color_text">Make your life easier</span>{" "}
              and <span className="events_color_text">risk free!</span>
            </p>
            <Link className="noodle_button" to="/browse">
              Browse
            </Link>
          </div>
          ...
          <div id="intro_right" className="intro_column">
            ...
            <div>
              ...
              <p>
                <span className="events_color_text">Risk Free!</span>
              </p>
            </div>
            <div id="intro_share">
              <h4>Share</h4>
              <ul id="share_buttons">
                <li className="share_button">
                  <a href="/#">
                    <img alt="Facebook" src={facebook_logo} />
                  </a>
                </li>
                <li className="share_button">
                  <a href="/#">
                    <img alt="LinkedIn" src={linkedin_logo} />
                  </a>
                </li>
                <li className="share_button">
                  <a href="/#">
                    <img alt="Pinterest" src={pinterest_logo} />
                  </a>
                </li>
                <li className="share_button">
                  <a href="/#">
                    <img alt="Reddit" src={reddit_logo} />
                  </a>
                </li>
              </ul>
            </div>
